...
describe('Pass Routes', () => {
  ...
  it('should return 201 when creating a new pass', async () => {
  ...
  it('should return 200 when fetching all passes', async () => {
  ...
  it('should return 200 when fetching a pass by id', async () => {
  ...
  it('should return 200 when updating a pass by id', async () => {
  ...
  it('should return 200 when deleting a pass by id', async () => {
